...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_slug.vue?vue&type=template&id=31cd6d2c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<section class=\"hero\""+(_vm._ssrStyle(null,{
      background:
        'url(//admin.vetsbenefitsconsulting.com' + _vm.page.hero.image.url + ')',
      ...
      backgroundPosition: 'center',
        ...
        background:
          ...
          ')',
      }, null))+"><div class=\"container\"><h1>"+_vm._ssrEscape(_vm._s(_vm.page.title))+"</h1></div></div></section> "),_vm._ssrNode("<section class=\"body\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_c('nuxt-content',{domProps:{"innerHTML":_vm._s(_vm.content)}})],1)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"cta\""+(_vm._ssrStyle(null,{
      background:
...
// CONCATENATED MODULE: ./pages/_slug.vue?vue&type=template&id=31cd6d2c&
